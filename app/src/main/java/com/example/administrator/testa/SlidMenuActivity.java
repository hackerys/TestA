 ...
 */
public class SlidMenuActivity extends Activity implements View.OnTouchListener {
    //滚动显示、隐藏菜单时手指需要达到的速度
    ...
    //初始化一些关键性的数据，包括获取屏幕的宽度，给content布局从新设置宽度和menu的宽度和偏移距离
    public void initeValues() {
    ...
    class Adapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            View mView = LayoutInflater.from(SlidMenuActivity.this).inflate(R.layout.list_item, null);
